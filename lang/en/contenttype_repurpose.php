...
$string['repurpose:useeditor'] = 'Create content using the with repurpose resources tools';
...
$string['previewquestion_help'] = 'A link is provided to preview the selected question if you have the permission to do so. Clicking the link should open a new window';
